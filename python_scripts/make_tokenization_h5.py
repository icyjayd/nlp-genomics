...
model_path = "/gpfs/data/johnsonslab/nlp-genomics/pasolli-2019/metagenomes_819k.model"
# model_path = "/gpfs/data/johnsonslab/nlp-genomics/pasolli-2019/metagenomes_1000bp_8192.model"

bpe = yttm.BPE(model=model_path)
vocab = set()
with open_file(os.path.join(path, "tokenizations_819k_poc_new.h5"), 'w') as h5file:
    ...
    h5file.create_array("/token_vocabulary", 'vocab', list(vocab))
