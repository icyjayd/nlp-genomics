...
def prepare_data(rank, world_size, data, batch_size=32, pin_memory=False, num_workers=0):
    ...
    train_set = UHGGDatasetH5(train_set, class_dict, path_to_db, label_col=label_col,
                                            pad_token = 0, pad_length = 1069919)
    val_loader = UHGGDatasetH5(val_set, class_dict, path_to_db, label_col=label_col,
                                          pad_token=0, pad_length = 1069919)
    test_loader = UHGGDatasetH5(test_set, class_dict, path_to_db, label_col = label_col,
                                           pad_token=0, pad_length = 1069919)
...
def main(rank, world_size):
    ...
    train_loader, val_loader, test_loader = prepare_data(rank, world_size, samples, batch_size=batch_size,
