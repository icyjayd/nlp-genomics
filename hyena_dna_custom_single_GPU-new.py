...
def train(model, device, train_loader, optimizer, epoch, loss_fn, log_interval=10000):
    ...
    torch.save({'model_state_dict':model.state_dict(), 'optimizer_state_dict':optimizer.state_dict(),'loss':loss}, '/gpfs/scratch/jic286/JohnsonLab/hyena-model-checkpoints/hyena-bpe-2_families-epoch_{}-24-02-29.pt'.format(epoch))
